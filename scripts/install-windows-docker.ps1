...
Write-Host "  powershell -ExecutionPolicy Bypass -File scripts\enable-windows-lan-access.ps1 -AppPort $AppPort -ListenAddress YOUR_SERVER_IP"
Write-Host "The helper excludes 192.168.1.x by default to avoid publishing on home networks."
Write-Host ""
